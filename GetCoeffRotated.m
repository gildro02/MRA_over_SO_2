% Input: N, Q, B, sigma, a_symm_1B, rho_func, t: parameters defining the
% rotation of the coefficient vector.
% Output: Matrix a_symm_1B_rot with N columns, where each column is a
% rotation of a_symm_1B drawn from rho_func with Gaussian Noise with std
% sigma.
function a_symm_1B_rot = GetCoeffRotated(parameters)

% Add all the relevent parameters to the workspace:
[N, Q, B, sigma, a_symm_1B, rho_func, t] = ...
    getStructFields(parameters, 'N', 'Q', 'B', 'sigma', 'a_symm_1B', 'rho_func', 't');
