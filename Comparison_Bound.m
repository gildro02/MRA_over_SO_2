...
for n=1:length(f_vec)
    ...
    % Calculate bound:
    bound(n) = boundForSpectralAlgorithm_NewVersion('B', B, 'Q', Q, 'sigma', sigma, 'rho_func',...
...
hold on
loglog(dist_from_circ/Q^2, error_squared_spectral./energy_of_a, ".", "MarkerSize", 10);
loglog(dist_from_circ/Q^2, error_squared_spectral_unrestricted./energy_of_a, ".", "MarkerSize", 10);
